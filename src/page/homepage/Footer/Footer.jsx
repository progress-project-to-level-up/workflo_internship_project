  ...
  return (
    ...
    <div className='footer-container'>
      <div className='work-flow-container'>
        ...
        <span className='work-text'>Help people who need working experience to develop themselves. It will also help the project creator save a lot of effort, time and money to get the best skills.</span>
