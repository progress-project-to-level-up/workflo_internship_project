...
import "../../homepage/SponsorCard/SponsorCard.css"

import SponsorImage from "../../../asset/svg/sponsorImage.svg"
...
const SponsorCard = () => {
  return (
    ...
    <div className='photoHolder'>
      <img src={SponsorImage} alt='Photo1' className='creator-photo'></img>
    </div>
